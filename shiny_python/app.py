...
# Load the dataset
def load_data():
  url = "PLACES__Local_Data_for_Better_Health__County_Data_2023_release.csv"
...
def server(input, output, session):
    ...
    def avg_data_value():
        ...
        return f"Average Depression Age-adjusted Prevalence for {selected_county}: {avg_value:.2f}%"
